...
const WhoWeAreImage = () => {
  return (
    <div className="group relative max-h-[400px] self-stretch rounded-lg border-1 border-zinc-200 border-opacity-15 p-2.5 xs:max-h-[450px] xs:p-4">
      <div className="absolute inset-0 m-2.5 rounded-lg bg-purple-900 opacity-35 transition-all duration-500 group-hover:opacity-0 xs:m-4"></div>
      <Image
