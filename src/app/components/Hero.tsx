...
const Hero = () => {
  return (
    ...
    >
      ...
      />
      <h3 className="mb-4 rounded-full border-2 border-secondary px-3 py-1 text-sm font-semibold uppercase">
        Welcome to Project Valhalla
      </h3>
      <h1 className="text-center text-4xl font-extrabold leading-tight xs:text-5xl md:text-6xl">
