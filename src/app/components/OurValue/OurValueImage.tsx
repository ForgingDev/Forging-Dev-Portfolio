...
const OurValueImage = () => {
  return (
    <div className="relative flex items-end self-stretch p-2 py-4 xs:pb-8 xs:pt-0 md:col-span-2">
      <Image
      ...
      <div className="z-10 mx-auto flex flex-col gap-y-5 md:w-3/4">
        ...
        <h3 className="text-xl font-bold xs:text-3xl">
          Smart Designs, Sharp Results - Discover the value of partnering with
          Us
        </h3>
        <p className="mb-1 text-sm leading-normal tracking-wide text-zinc-300 xs:text-base">
